...
# PhoenixWebpackExample.Web.Endpoint.load_from_system_env/1 dynamically.
...
# start per endpoint:
#
#     config :phoenix_webpack_example_web, PhoenixWebpackExample.Web.Endpoint, server: true
#
